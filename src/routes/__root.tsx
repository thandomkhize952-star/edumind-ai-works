...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "EduMind AI — Smart Learning Management" },
      { property: "og:description", content: "AI-powered learning platform for students, lecturers and administrators." },
      { name: "twitter:description", content: "AI-powered learning platform for students, lecturers and administrators." },
