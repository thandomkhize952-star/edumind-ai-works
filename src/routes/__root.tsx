...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EduMind AI — Smart Learning Platform" },
      { name: "description", content: "All-in-one AI-powered learning platform for students, lecturers and administrators." },
      { property: "og:title", content: "EduMind AI — Smart Learning Platform" },
      { name: "twitter:title", content: "EduMind AI — Smart Learning Platform" },
